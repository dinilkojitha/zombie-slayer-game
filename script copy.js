...
function heroIdleAnimation(){
    ...
    heroIdleWorker = setInterval(()=>{
        ...
        document.getElementById("hero").src = "hero/Idle (" + heroIdleImageNumber + ").png";
...
function heroAttack(){
    ...
    heroAttackWorker = setInterval(()=>{
        ...
        document.getElementById("hero").src = "hero/Attack (" + heroAttackImageNumber + ").png";
...
function zombieIdleAnimation(){
    ...
    zombieIdleWorker = setInterval(()=>{
        ...
        document.getElementById("zombie").src = "femaleZombie/Idle (" + zombieIdleImageNumber + ").png";
...
function walk(){
    ...
    walkWorker = setInterval(()=>{
        ...
        document.getElementById("zombie").src = "femaleZombie/Walk (" + zombieWalkImageNumber + ").png"
...
function zombieAttack(){
    ...
    zombieAttackWorker = setInterval(()=>{
        ...
        if (zombieML <= heroML && walkWorker == 0 ){
            zombieScale = +1;
            document.getElementById("zombie").src = "femaleZombie/Attack (" + zombieAttackImageNumber + ").png"; 
            document.getElementById("zombie").style.transform = "scalex(" + zombieScale + ")";
        }
...
function zombieDead(){
    ...
    zombieDeadWorker = setInterval(()=>{
        ...
        document.getElementById("zombie").src = "femaleZombie/Dead (" + zombieDeadImageNumber +").png";
